        ...
        <td style="border-left: 1px solid black;border-right: 1px solid black;border-bottom: 1px solid black;" width="672">
            <table cellpadding="1" cellspacing="1">
                ...
                <tr>
                    <td style="width: 530px">
                        <table cellpadding="0">
                            <tr nobr="true">
                                ...
                                <td style="text-align: center;color: red;font-size: 17px;width: 150px;border-top: 1px solid black;border-right: 1px solid black;border-bottom: 1px solid black;"><b>$appInfo->application_number</b></td>
                            </tr>
                            <tr nobr="true">
                    ...
                    <td><img style="vertical-align:middle;" height="140" width="150" src="$photoInfo->doc_path" alt="Student Image"></td>
                </tr>
            </table>
        </td>
    </tr>
...
<table width="675" border="1" cellpadding="4" cellspacin="1">
    ...
    <tr>
        <td width="675"><p style="font-size: 12px;"><i>Place: Bangalore</i></p>
