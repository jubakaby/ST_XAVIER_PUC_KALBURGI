                                                    ...
                                                    <div class="card-body" style="padding:5px;">
                                                        ...
                                                        <table class="table table-hover">
                                                            <thead>
                                                                ...
                                                                <tr class="table-success">
                                                                    <th class="text-left" scope="col">Father Name</th>
                                                                    <th class="text-left" scope="col">
                                                                        <?php echo $studentInfo->father_name; ?></th>
                                                                </tr>
                                                                <tr class="table-primary">
                                                                    <th class="text-left" scope="col">Application No.
                                                                    </th>
                                                                    <th class="text-left" scope="col">
                                                                        <?php echo $studentInfo->application_number; ?>
                                                                    </th>
                                                                </tr>
                                                                <tr class="table-success">
                                                                ...
                                                                <tr class="table-primary">
                                                                    ...
                                                                    <th class="text-left" scope="col">I PUC  <?php echo $studentInfo->stream_name; ?></th>
                                                                </tr>
                                                                <tr class="table-success">
                                                                    <th class="text-left" scope="col">10th Board</th>
                                                                    <th class="text-left" scope="col">
                                                                       <?php if($board_id == 1){
                                                                           echo 'SSLC';
                                                                       } else if($board_id == 2){
                                                        ...
                                                        <div class="col-12">
                                                           ...
                                                           <b>You will receive the payment details via SMS. Receipt copy will be given later</b>
                                                            </ul>
                                                            </div>
                                                        </div>
    ...
    <div class="modal-dialog modal-lg" role="document">
        <div class="modal-content">
            ...
            <div class="modal-body" >
                ...
                <h6>APPLICATION NO: <b><?php echo $studentInfo->application_number; ?></b></h6>
                <h6>SECTION : ....................................................ROLL NO :
                    ........................................</h6>
