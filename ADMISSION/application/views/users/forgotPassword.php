            ...
            <form action="<?php echo base_url(); ?>resetPasswordUser" method="post" id="studentForgotPassword">
                <div class="form-group">
                  <label class="email mdc-text-field mdc-text-field--filled ">
                    ...
                    <input type="text"  name="student_id" id="student_id" class="mdc-text-field__input" aria-labelledby="my-label-id" autocomplete="off" required/>
              ...
              <div class="row mt-2">
                <div class="col-xs-6 col-sm-6  col-md-12">
                  <input type="submit" class="mdc-button mdc-button--raised btn btn_submit btn-block" value="Change" />
                </div>
              </div>
              <div class="row">
                <div class="col-xs-6 col-sm-6 col-md-12">
