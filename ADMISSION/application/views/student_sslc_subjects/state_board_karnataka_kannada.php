...
<table class="table table-bordered text-center">
    <thead>
        <tr style="background: #337ab7; color:white;">
            <th colspan="4">
                <span class="float-left">9th/10th STANDARD MARK INFO</span>
            </th>
        </tr>
        <tr style="background: #337ab7; color:white;">
            <th>SUBJECT</th>
    ...
    <tbody>
        <tr>
            ...
            <th><input style="text-transform: uppercase" id="subject_max_mark" type="text" name="subject_max_mark[]" class="form-control required input-sm" value="125"  readonly /></th>
        ...
        <tr>
            <th><input id="subject_name" type="text" name="subject_name[]" required class="form-control required input-sm" value="MATHEMATICS" readonly/></th>
            <th><input id="subject_max_mark" type="text" name="subject_max_mark[]" class="form-control required input-sm" value="100" readonly/></th>
            <td><input maxlength="3" onkeypress="return isNumber(event)" id="subject_obtained" type="text" name="subject_obtained[]" class="form-control required input-sm" placeholder="Enter 10th Standard Mark" autocomplete="off" required/></td>
        <td><input maxlength="3" onkeypress="return isNumber(event)" id="obt_mark_9_std" type="text" name="obt_mark_9_std[]" class="form-control  input-sm" placeholder="Enter 9th Standard Mark" autocomplete="off"  /></td>
        </tr>
        <tr>
            <th><input id="subject_name" type="text" name="subject_name[]" required class="form-control required input-sm" value="SCIENCE" readonly/></th>
            <th><input id="subject_max_mark" type="text" name="subject_max_mark[]" class="form-control required input-sm" value="100" readonly/></th>
            <td><input maxlength="3" onkeypress="return isNumber(event)" id="subject_obtained" type="text" name="subject_obtained[]" class="form-control required input-sm" placeholder="Enter 10th Standard Mark" autocomplete="off" required/></td>
        <td><input maxlength="3" onkeypress="return isNumber(event)" id="obt_mark_9_std" type="text" name="obt_mark_9_std[]" class="form-control  input-sm" placeholder="Enter 9th Standard Mark" autocomplete="off"  /></td>
        </tr>
        <tr>
            <th><input id="subject_name" type="text" name="subject_name[]" required class="form-control required input-sm" value="SOCIAL SCIENCE" readonly/></th>
            <th><input id="subject_max_mark" type="text" name="subject_max_mark[]" class="form-control required input-sm" value="100" readonly/></th>
            <td><input maxlength="3" onkeypress="return isNumber(event)" id="subject_obtained" type="text" name="subject_obtained[]" class="form-control required input-sm" placeholder="Enter 10th Standard Mark" autocomplete="off" required/></td>
        <td><input maxlength="3" onkeypress="return isNumber(event)" id="obt_mark_9_std" type="text" name="obt_mark_9_std[]" class="form-control  input-sm" placeholder="Enter 9th Standard Mark" autocomplete="off" /></td>
        </tr>
