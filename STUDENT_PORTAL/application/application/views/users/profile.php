    ...
    <div class="col-lg-3 col-md-3 col-sm-3 pr-0 padding_left_right_null">
      <div class="card card-small c-border mb-4 p-1">
        <div class="card-header text-center profile-img">
          <img  src="http://sjpuc.schoolphins.com/assets/images/PHOTOS_20_21_ALL/<?php echo $student_id; ?>.png"  class="avatar rounded-circle img-thumbnail" width="130" height="130" alt="User Image" >  
        </div>
