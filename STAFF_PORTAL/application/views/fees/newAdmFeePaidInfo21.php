                        ...
                        <div class="row c-m-b">
                            <div class="col-lg-4 col-12 col-md-5 box-tools">
                                <span class="page-title">
                                    <i class="material-icons">book</i> Fee Paid Info I PUC 2021
                                </span>
                            </div>
                            ...
                            data-toggle="modal" data-target="#orderIDProcesse" id="orderID"><i class="fas fa-university"></i>
                               Order ID Process</a>
                    ...
                    <div class="card-body p-1 pb-2 text-center table-responsive">
                        <table class="table table-bordered text-dark mb-0">
                            <thead class="text-center">
                                <form action="<?php echo base_url(); ?>getAllFeePaymentInfoNewAdm" method="POST"
                                    id="byFilterMethod">
                                    <tr>
                                ...
                                <tr class="text-dark">
                                    <th><input type="checkbox" class="singleSelect"
                                            value="<?php echo $online->receipt_number; ?>" /></th>
                                    ...
                                    ?></td>
                                    <td>
                                        <a href="<?php echo base_url(); ?>feePaymentReceiptPrintNewAdmIPUC/<?php echo $online->receipt_number; ?>"
                ...
                <div class="row">
                    <div class="col-lg-12">
                        ...
                        <div class="form-group">
                            ...
                            <input  type="text" style="text-transform:uppercase" placeholder="Enter Order ID" id="order_id" name="order_id" class="form-control" value=""
                                required></input>
                        </div>
...
jQuery(document).ready(function() {
    ...
    jQuery('ul.pagination li a').click(function(e) {
        ...
        jQuery("#byFilterMethod").attr("action", baseURL + "getAllFeePaymentInfoNewAdm/" + value);
    ...
    $('#addBankSettlementSubmit').click(function() {
        ...
        if ($('#settle_date_bank') == "") {
          ...
          Please select Settlement date !
            ...
            $.ajax({
                url: baseURL + '/addBankSettlementSubmitNewAdm',
                type: 'POST',
                data: {
