                            ...
                            <div class="col-lg-12 col-12 col-md-12 box-tools">
                                <span class="page-title">
                                    <i class="fa fa-file"></i> <span style="font-size: 23px;font-weight: 600;">
                                     I PUC Payment Portal
                                    </span>
                                    <small>Admission 2021</small>
                                </span>
                            </div>
                        </div>
                    </div>
        ...
        <div class="row p-0 column_padding_card">
            ...
            <div class="col column_padding_card">
                <div class="card card-small mb-4">
                    ...
                    <form action="<?php echo base_url() ?>getNewAdm_StudentFeePaymentInfo" method="POST">
                            <div class="row">
                                ...
                                <div class="col-12">
                                    <div class="input-group mb-3">
                                        ...
                                        <?php if(!empty($application_no)){?>
                                                <option value="<?php echo $application_no; ?>" selected><?php echo $application_no; ?></option>
                                           <?php }   ?> 
                                        <option value="">Select Student</option>
                                        <?php if(!empty($allStudentInfo)){
                                        foreach($allStudentInfo as $std){  ?>
                                        <option value="<?php echo $std->application_no; ?>">
                                            <b><?php echo $std->application_no.' - '.$std->student_name; ?></b></option>
                                        <?php } } ?>
                                    </select>
                                                ...
                                                <table class="table table-hover">
                                                    <thead>
                                                        ...
                                                        <tr class="table-success">
                                                            ...
                                                            <th class="text-left" scope="col">
                                                                <?php echo $studentInfo->application_number ?></th>
                                                        </tr>
                                                        ...
                                                        <tr class="table-success">
                                                            ...
                                                            <tr class="table-primary">
                                                                ...
                                                                <th class="text-left" scope="col"> 
                                                                    <?php echo $studentInfo->student_category; ?>
                                                                </th>
                                                            </tr> 
                                                ...
                                                <?php if(!empty($feePaidInfo)){ ?>
                                                  ...
                                                  <?php foreach($feePaidInfo as $fee){ ?>
                                                    <tr class="table-info">
                                                            ...
                                                            <th class="text-left" scope="col">
                                                            <a href="<?php echo base_url(); ?>feePaymentReceiptPrintNewAdmIPUC/<?php echo $fee->receipt_number; ?>"
    ...
    <div class="modal-dialog modal-lg">
        <div class="modal-content">
            ...
            <div class="modal-body p-2">
                ...
                <form role="form" id="addFeePaymentInfo" action="<?php echo base_url() ?>newAdm_AddFeePaymentInfo"
                    ...
                    <input type="hidden" name="application_no" value="<?php echo $studentInfo->application_number ; ?>" required />
