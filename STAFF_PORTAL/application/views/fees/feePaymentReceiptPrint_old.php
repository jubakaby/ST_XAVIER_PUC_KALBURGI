        ...
        <div class="border_full" style="padding:3px">
            ...
            <table class="table" style="font-size: 12px;">
                ...
                <tr>
                    ...
                    <td>Term : <?php echo $studentInfo->term_name; ?></td>
                </tr>
            ...
            <table class="table table_bordered" style="font-size: 12px;">
                ...
                <tr>
                    ...
                    <th><?php echo $fee_name; ?></th>
                    <th class="" style="text-align: right;"><?php echo $paid_amount; ?></th>
                </tr>
                <tr>
            ...
            <table class="table " style="font-size: 12px;">
                <tr>
                    ...
                    <td style="text-align:right;"><b>Director</b></td>
                            ...
                            <div class="border_full" style="padding:2px;">
                                <p style="margin-bottom: 0px;font-size: 13px;">DD/Transaction Number:
                                    <?php echo $ddInfo->dd_number; ?></p>
                                <p style="margin-bottom: 0px;font-size: 13px;">Bank Name: <?php echo $ddInfo->bank_name; ?></p>
                            </div>
                            <br>
