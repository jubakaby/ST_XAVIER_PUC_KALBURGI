    ...
    <div class="row">
        ...
        <table class="table" style="text-align:center;">
            ...
            <table class="table" style="font-size: 12px;">
                <tr>
                    <td width="210">Application No. : <?php echo $feeInfo->application_no; ?></td>
                    <td style="text-align:right;">Date : <?php echo date('d-m-Y'); ?></td>
                </tr>
                <tr>
                    <td colspan="2">Name : <b><?php echo $feeInfo->name; ?></b></td>
                </tr>
                <tr>
                    <td colspan="2">Class : I PUC</td>
                </tr>
                <tr>
                    <td>COMBINATION : <?php echo strtoupper($feeInfo->stream_name.'/'.$feeInfo->second_language); ?></td>
                </tr>
            </table>
            <table class="table table_bordered" style="font-size: 12px;">
                ...
                <tr>
                    ...
                    <th class="" style="text-align: right;"><?php echo $feeInfo->amount; ?></th>
                </tr>
                <tr>
                ...
                <tr>
                    <td colspan="2"><br><br><br>Paid Total amount in words: <span style="text-transform: capitalize;"><?php echo strtoupper(getIndianCurrency($feeInfo->amount)).' ONLY'; ?></span></td>
